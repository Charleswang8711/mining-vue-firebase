<template>
	<div class="container">
	    ...
	    <h3 class="center deep-purple-text">Standby Setup</h3>
	    

  	    <div class="section">
  	    <h5 class="h5 left deep-purple-text">Add Standby</h5>
	...
	methods: {
		...
		addComment(){
			if(this.comment)
			{
				...
				let ref = db.collection('StandbySuper').doc(this.comment)
		 ...
		 deleteComment(id){
    		db.collection('StandbySuper').doc(id).delete()
   			 .then(() => {
